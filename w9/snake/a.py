...
from os import scandir, terminal_size
...
def main():
    global SCREEN, CLOCK,step,score,bf,time_limit,start_time,elapsed_time,text,counter
    pygame.init()
    ...
    pygame.time.set_timer(new_food,5000)
    while game:
